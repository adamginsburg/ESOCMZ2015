...
\begin{itemize}
    ...
    \item PMO has been running a large scale CO/\cob/\coc\ (1--0) mapping survey, the
    Milky Way Imaging Scroll Painting (MWISP, \citealt{Jiang2013-MWISP})
    which will eventually map the northern Galactic plane within $b<|5|^\circ$. The project started in 2010 and so far a large fraction of plane has been observed. Progress can be found at \url{http://www.radioast.nsdc.cn/viewallobsed.php}.
